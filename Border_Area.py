...
def find_boarder(apple_image):
    ...
    w=0
    for i in range(0,80):
        r,v,b=apple_image.getpixel((160,i))
        #print(r,v,b)
        lumi=r+v+b
        if lumi > 60:
            n=i
    ...
    for i in range(30, 100):
        r,v,b=apple_image.getpixel((i,120))
...
def crop(image):
    ...
    left = centre_x-Apple_Diameter/4
    top = centre_y-Apple_Diameter/4
    right = centre_x+Apple_Diameter/4
    bottom = centre_y+Apple_Diameter/4
...
START = r'C:\Users\tgillard\Desktop\internship\1_Sorted apples\T4 Royal Gala_trie\Basics\3defect'
STOP = r'C:\Users\tgillard\Desktop\internship\1_Crop Sorted apples\T4 Royal Gala_trie\Basics\3defect'

#crop_a_file(START, STOP)

affichage(r'C:\Users\tgillard\Desktop\internship\applepic\1 Braeburn\1 Braeburn\001-06.BMP')
